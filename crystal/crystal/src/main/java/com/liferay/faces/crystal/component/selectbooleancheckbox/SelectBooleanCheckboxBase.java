 ...
 * details.
 */
package com.liferay.faces.crystal.component.selectbooleancheckbox;
//J-
...
public abstract class SelectBooleanCheckboxBase extends HtmlSelectBooleanCheckbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.crystal.component.selectbooleancheckbox.SelectBooleanCheckbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.crystal.component.selectbooleancheckbox.SelectBooleanCheckboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "crystal-select-boolean-checkbox");
	}
}
//J+
