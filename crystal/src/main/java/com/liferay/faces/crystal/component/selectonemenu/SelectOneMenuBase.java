 ...
 * details.
 */
package com.liferay.faces.crystal.component.selectonemenu;
//J-
...
public abstract class SelectOneMenuBase extends HtmlSelectOneMenu implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.crystal.component.selectonemenu.SelectOneMenu";
	public static final String RENDERER_TYPE = "com.liferay.faces.crystal.component.selectonemenu.SelectOneMenuRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "crystal-select-one-menu");
	}
}
//J+
