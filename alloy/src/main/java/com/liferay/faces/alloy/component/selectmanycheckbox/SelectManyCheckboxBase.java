 ...
 * details.
 */
package com.liferay.faces.crystal.component.selectmanycheckbox;
//J-
...
public abstract class SelectManyCheckboxBase extends HtmlSelectManyCheckbox implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.crystal.component.selectmanycheckbox.SelectManyCheckbox";
	public static final String RENDERER_TYPE = "com.liferay.faces.crystal.component.selectmanycheckbox.SelectManyCheckboxRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "crystal-select-many-checkbox", "checkbox");
	}
}
//J+
