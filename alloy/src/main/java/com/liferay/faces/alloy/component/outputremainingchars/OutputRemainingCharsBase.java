 ...
 * details.
 */
package com.liferay.faces.crystal.component.outputremainingchars;
//J-
...
public abstract class OutputRemainingCharsBase extends OutputTextBase implements Styleable, ClientComponent {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.crystal.component.outputremainingchars.OutputRemainingChars";
	public static final String RENDERER_TYPE = "com.liferay.faces.crystal.component.outputremainingchars.OutputRemainingCharsRenderer";
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "crystal-output-remaining-chars");
	}
}
//J+
