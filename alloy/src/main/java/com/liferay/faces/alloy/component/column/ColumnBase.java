 ...
 * details.
 */
package com.liferay.faces.crystal.component.column;
//J-
...
public abstract class ColumnBase extends HtmlColumn implements Styleable {
	...
	// Public Constants
	public static final String COMPONENT_TYPE = "com.liferay.faces.crystal.component.column.Column";
	public static final String RENDERER_TYPE = "com.liferay.faces.crystal.component.column.ColumnRenderer";
	 ...
	 * <br /><br />
	 * When crystal:column is a child of crystal:dataTabe, this is the JavaBean property that is to be used for filtering.
	 */
	 ...
	 * <br /><br />
	 * When crystal:column is a child of crystal:dataTable, this is the text for the column header. This attribute can be used as a convenience instead of specifying a child <code>&lt;f:facet name="header" /&gt;</code> tag.
	 */
	 ...
	 * <br /><br />
	 * When crystal:column is a child of crystal:dataTabe, this is the JavaBean property that is to be used for sorting.
	 */
	...
	public String getStyleClass() {
		...
		return com.liferay.faces.util.component.ComponentUtil.concatCssClasses(styleClass, "crystal-column");
	}
