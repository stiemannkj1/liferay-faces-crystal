 ...
 * details.
 */
package com.liferay.faces.metal.component.overlay.internal;
 ...
 */
public abstract class OverlayRendererBase extends DelegatingMetalRendererBase implements NamingContainer {
	...
	protected void encodeOverlayHiddenAttributes(FacesContext facesContext, ResponseWriter responseWriter,
		...
		// Encode the "contentBox" Metal hidden attribute.
	...
	protected void encodeOverlayJavaScriptCustom(ResponseWriter responseWriter, FacesContext facesContext,
		...
		// blinking when Metal's JavaScript attempts to hide the boundingBox. At this point in JavaScript execution,
		// Metal is done manipulating the DOM and it is necessary to remove the "display:none;" so that the
	...
	protected void encodeOverlayMarkupBegin(FacesContext facesContext, UIComponent uiComponent,
		...
		// that Metal's JavaScript will be able to locate the boundingBox in the DOM.
