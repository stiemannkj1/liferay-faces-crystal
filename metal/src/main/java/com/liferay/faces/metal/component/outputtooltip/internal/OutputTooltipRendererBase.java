...
import com.liferay.faces.metal.component.overlay.internal.OverlayRendererBase;
...
public abstract class OutputTooltipRendererBase extends OverlayRendererBase {
	...
	@Override
	public void encodeMetalAttributes(FacesContext facesContext, ResponseWriter responseWriter, UIComponent uiComponent) throws IOException {
	...
	// Modules
	private static final String[] MODULES = new String[] { "metal-tooltip/src/Tooltip" };
