 ...
 * details.
 */
package com.liferay.faces.metal.component.outputtooltip.internal;
...
import com.liferay.faces.metal.component.outputtooltip.OutputTooltip;
...
//		@ResourceDependency(library = "liferay-faces-metal-reslib", name = "metaljs/build/amd/metal/src/metal.js"),
		...
		@ResourceDependency(library = "liferay-faces-metal-reslib", name = "metaljs/build/amd/metal-tooltip/src/Tooltip-min.js")
	}
)
//J+
public class OutputTooltipRenderer extends OutputTooltipRendererBase {
	...
	public void encodeJavaScriptCustom(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		if ((tooltip.getFor() == null) && facesContext.isProjectStage(ProjectStage.Development)) {
			logger.error("The 'for' attribute is required for metal:outputTooltip");
		}
	...
	protected void encodeHiddenAttributes(FacesContext facesContext, ResponseWriter responseWriter,
		...
		// Encode the "cssClass" Metal hidden attribute.
