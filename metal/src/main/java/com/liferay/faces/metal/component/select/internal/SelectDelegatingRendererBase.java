 ...
 * details.
 */
package com.liferay.faces.metal.component.select.internal;
 ...
 * with Liferay Portal's (and MetalJS's) style, SelectDelegatingRendererBase replaces the default ResponseWriter with
