...
/**
 * This is an abstract class that provides base rendering functionality for MetalUI JavaScript components.
 *
 * @author  Kyle Stiemann
 */
public abstract class MetalRendererBase extends ClientComponentRendererBase implements MetalRenderer {
