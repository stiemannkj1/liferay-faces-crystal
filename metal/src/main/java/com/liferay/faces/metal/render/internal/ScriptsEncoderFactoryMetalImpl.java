 ...
 */
public class ScriptsEncoderFactoryMetalImpl extends ScriptsEncoderFactory implements Serializable {
	...
	public ScriptsEncoderFactoryMetalImpl(ScriptsEncoderFactory scriptEncoderFactory) {

		if (LIFERAY_PORTAL_DETECTED && LIFERAY_FACES_BRIDGE_DETECTED) {
			this.scriptsEncoder = scriptEncoderFactory.getScriptsEncoder();
		}
		else {
			this.scriptsEncoder = new ScriptsEncoderMetalImpl();
		}
