...
//		@ResourceDependency(library = "liferay-faces-metal-reslib", name = "metaljs/build/amd/metal/src/metal.js"),
		...
		@ResourceDependency(library = "liferay-faces-metal-reslib", name = "metaljs/build/amd/metal-modal/src/Modal-min.js")
	}
)
//J+
public class DialogRenderer extends DialogRendererBase {
	...
	// Modules
	private static final String[] MODULES = new String[] { "metal-modal/src/Modal" };
